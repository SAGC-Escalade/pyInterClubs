...
export function Medal({ rank, sexe=undefined }) {
    if (rank > 3)
        return "";

    if (sexe == 1) sexe = 'femme';
    if (sexe == 2) sexe = 'homme';

    const background = [0, "gold", "silver", "bronze"][rank];
    let number;
    if (rank == 1) number = (<path fill="currentColor" d="M160 64c0-11.8-6.5-22.6-16.9-28.2s-23-5-32.8 1.6l-96 64C-.5 111.2-4.4 131 5.4 145.8s29.7 18.7 44.4 8.9L96 123.8 96 416l-64 0c-17.7 0-32 14.3-32 32s14.3 32 32 32l96 0 96 0c17.7 0 32-14.3 32-32s-14.3-32-32-32l-64 0 0-352z" transform="translate(-128 -256)"></path>)
    else if (rank == 2) number = (<path fill="currentColor" d="M142.9 96c-21.5 0-42.2 8.5-57.4 23.8L54.6 150.6c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L40.2 74.5C67.5 47.3 104.4 32 142.9 32C223 32 288 97 288 177.1c0 38.5-15.3 75.4-42.5 102.6L109.3 416 288 416c17.7 0 32 14.3 32 32s-14.3 32-32 32L32 480c-12.9 0-24.6-7.8-29.6-19.8s-2.2-25.7 6.9-34.9L200.2 234.5c15.2-15.2 23.8-35.9 23.8-57.4c0-44.8-36.3-81.1-81.1-81.1z" transform="translate(-160 -256)"></path>)
    else if (rank == 3) number = (<path fill="currentColor" d="M0 64C0 46.3 14.3 32 32 32l240 0c13.2 0 25 8.1 29.8 20.4s1.5 26.3-8.2 35.2L162.3 208l21.7 0c75.1 0 136 60.9 136 136s-60.9 136-136 136l-78.6 0C63 480 24.2 456 5.3 418.1l-1.9-3.8c-7.9-15.8-1.5-35 14.3-42.9s35-1.5 42.9 14.3l1.9 3.8c8.1 16.3 24.8 26.5 42.9 26.5l78.6 0c39.8 0 72-32.2 72-72s-32.2-72-72-72L80 272c-13.2 0-25-8.1-29.8-20.4s-1.5-26.3 8.2-35.2L189.7 96 32 96C14.3 96 0 81.7 0 64z" transform="translate(-160 -256)"></path>)

    return (
        <i className="fa-layers fa-fw fa-lg me-3">
            <svg className={`svg-inline--fa sexe ${sexe}`} aria-hidden="true" focusable="false" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" style={{ transformOrigin: "0.5em 0.5625em" }}>
    ...
    return (
        <li className={`list-group-item d-flex ${background}`} key={score.id} ref={ref}>
            ...
            <div className="text-end text-nowrap ms-auto">
                <Medal rank={score.rank} sexe={score.sexe} />
